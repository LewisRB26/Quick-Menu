...
5. For Spotify shortcut to run, Spotify needs to be installed, but the shortcut is not required
...
-If you found this shortcut useful, leave a star so more users can find it.
